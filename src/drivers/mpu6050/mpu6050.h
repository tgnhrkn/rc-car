...
#define MPU6050_XG_OFFS_USRH       0x06   // R/W
#define MPU6050_XG_OFFS_USRL       0x07   // R/W
#define MPU6050_YG_OFFS_USRH       0x08   // R/W
#define MPU6050_YG_OFFS_USRL       0x09   // R/W
#define MPU6050_ZG_OFFS_USRH       0x0A   // R/W
#define MPU6050_ZG_OFFS_USRL       0x0B   // R/W
...
#define MPU6050_I2C_ADDRESS_AD0_LO 0x68
#define MPU6050_I2C_ADDRESS_AD0_HI 0x69
...
typedef union accel_offset_union
{
  struct
  {
    uint8_t x_h;
...
} mpu6050_accel_offsets_t;

#define MPU6050_XACC_OFFSET -560
#define MPU6050_YACC_OFFSET 1365
#define MPU6050_ZACC_OFFSET 865

int MPU6050_Device_Reset(void);
void MPU6050_Startup(void);
void MPU6050_Init(void);
int MPU6050_Accel_Offset_Get(mpu6050_accel_offsets_t *);
int MPU6050_Accel_Offset_Set(mpu6050_accel_offsets_t *);

int MPU6050_Read_Sensor_Data(mpu6050_sensor_data_t *);
int MPU6050_Enable_Data_Interrupt(void);
int MPU6050_Set_Sample_Rate(uint8_t);
